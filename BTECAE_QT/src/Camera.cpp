...
Camera::Camera() noexcept
{
  ...
  m_height=576;
  m_eye.set(1,1,1);
  //ngl::Mat4 yourNGLMatrix;
  //memcpy(yourNGLMatrix.m_m,glm::value_ptr(yourNGLMatrix,sizeof(yourNGLMatrix.m_m));//copies the values from an ngl matrix to 
}


//----------------------------------------------------------------------------------------------------------------------
void Camera :: setDefaultPerspCamera() noexcept
{
  // make default camera
  m_eye=1.0f;
  m_look=0.0f;
